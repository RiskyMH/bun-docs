...
fullTitle: Debugging Bun with the VS Code extension
mode: center
---

<Callout type="info">The VS Code extension is buggy. We recommend the [web debugger](/guides/runtime/web-debugger) instead.</Callout>
