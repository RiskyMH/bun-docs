...
fullTitle: Deploy a Bun application on DigitalOcean
mode: center
---
...
<Steps>
	<Step>
	  ...
	  ### Create a new DigitalOcean Container Registry
    	...
    	<Tabs items={['Through the DigitalOcean dashboard', 'Through the DigitalOcean CLI']}>
    		<Tab value="Through the DigitalOcean dashboard">
    			...
    			<Frame>
    				![DigitalOcean registry dashboard](https://bun.com/docs/images/guides/digitalocean-7.png)
    			</Frame>

    			Make sure the details are correct, then click **Create Registry**.
    		</Tab>
    		<Tab value="Through the DigitalOcean CLI">
    	...
    	<Frame>
    		![DigitalOcean registry dashboard](https://bun.com/docs/images/guides/digitalocean-1.png)
    	</Frame>
    </Step>
    <Step>
    ...
    <Step>
      ...
      ### Build and push the Docker image to the DigitalOcean registry
    	...
    	<Frame>
    		![DigitalOcean registry dashboard](https://bun.com/docs/images/guides/digitalocean-2.png)
    	</Frame>
    </Step>
    <Step>
      ...
      ### Create a new DigitalOcean App Platform project
    	...
    	<Frame>
    		![DigitalOcean App Platform project dashboard](https://bun.com/docs/images/guides/digitalocean-3.png)
    	</Frame>

    	Make sure the details are correct, then click **Next**.

    	<Frame>
    		![DigitalOcean App Platform service dashboard](https://bun.com/docs/images/guides/digitalocean-4.png)
    	</Frame>

    	Review and configure resource settings, then click **Create app**.

    	<Frame>
    		![DigitalOcean App Platform service dashboard](https://bun.com/docs/images/guides/digitalocean-6.png)
    	</Frame>
    </Step>
    <Step>
      ...
      ### Visit your live application
    	...
    	<Frame>
    		![DigitalOcean App Platform app dashboard](https://bun.com/docs/images/guides/digitalocean-5.png)
    	</Frame>
    </Step>
