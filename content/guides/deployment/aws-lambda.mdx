...
fullTitle: Deploy a Bun application on AWS Lambda
mode: center
---
...
<Steps>
    ...
    <Step>
      ...
      ### Create an AWS Lambda function
    	...
    	<Callout type="warning">Make sure you've selected the right region, this URL defaults to `us-east-1`.</Callout>

    	<Frame>
    	![Create Function](https://bun.com/docs/images/guides/lambda1.png)
    	</Frame>
    ...
    <Step>
      ...
      ### Select the container image
    	...
    	<Frame>
    	![Select Container Repository](https://bun.com/docs/images/guides/lambda2.png)
    	</Frame>

    	Then, select the `latest` image, and click on **Select image**.

    	<Frame>
    	![Select Container Image](https://bun.com/docs/images/guides/lambda3.png)
    	</Frame>
    </Step>
    <Step>
      ...
      ### Configure the function
    	...
    	<Frame>
    		![Set the Function URL](https://bun.com/docs/images/guides/lambda4.png)
    	</Frame>
    </Step>
    <Step>
      ...
      ### Create the function
    	...
    	<Frame>
    		![Create Function](https://bun.com/docs/images/guides/lambda6.png)
    	</Frame>
    ...
    <Step>
      ...
      ### Get the function URL
    	...
    	<Frame>
    		![Function URL](https://bun.com/docs/images/guides/lambda5.png)
    	</Frame>
    </Step>
    <Step>
