...
import { ServerIcon, CogIcon } from "lucide-react";

<Cards className="grid-cols-2">
  <Card title="systemd" href="/guides/ecosystem/systemd" icon={<ServerIcon />}>
    Run your bot as a Linux daemon
  </Card>
  <Card title="PM2" href="/guides/ecosystem/pm2" icon={<CogIcon />}>
