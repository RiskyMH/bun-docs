...
<Callout type="info">This document is for maintainers and contributors to Bun, and describes internal implementation details.</Callout>
...
```rust title="src/jsc/bindgen_test.rs"
...
```ts title="src/jsc/bindgen_test.bind.ts"
