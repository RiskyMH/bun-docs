...
<video style={{ aspectRatio: "2062 / 1344", objectFit: "contain" }} loop autoPlay muted playsInline>
  <source src="https://bun.com/bun-create-shadcn.mp4" style={{ objectFit: "contain" }} type="video/mp4" />
</video>
