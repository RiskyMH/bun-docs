...
![Left: Bun v1.1.44. Right: Node.js v23.6.0](https://bun.com/bun-s3-node.gif)
...
const client = new S3Client({ // [!code highlight]
	accessKeyId: "your-access-key", // [!code highlight]
	secretAccessKey: "your-secret-key", // [!code highlight]
	bucket: "my-bucket", // [!code highlight]
	// sessionToken: "..." // [!code highlight]
	endpoint: "https://s3.us-east-1.amazonaws.com", // [!code highlight]
	// endpoint: "https://<account-id>.r2.cloudflarestorage.com", // Cloudflare R2 // [!code highlight]
	// endpoint: "http://localhost:9000", // MinIO // [!code highlight]
}); // [!code highlight]
...
const supabase = new S3Client({ // [!code highlight]
	accessKeyId: "access-key", // [!code highlight]
	secretAccessKey: "secret-key", // [!code highlight]
	bucket: "my-bucket", // [!code highlight]
	region: "us-west-1", // [!code highlight]
	endpoint: "https://<account-id>.supabase.co/storage/v1/s3/storage", // [!code highlight]
}); // [!code highlight]
```
...
await S3Client.write('data.json', JSON.stringify({ hello: "world" }), { // [!code highlight]
	...
	type: "application/json", // [!code highlight]
}); // [!code highlight]
...
await S3Client.write('public.html', html, { // [!code highlight]
	...credentials, // [!code highlight]
	acl: "public-read", // [!code highlight]
	type: "text/html", // [!code highlight]
}); // [!code highlight]
```
