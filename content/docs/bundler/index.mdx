...
<Callout type="info">See [loaders](/docs/bundler/loaders) for more on the file loader.</Callout>
...
<Callout type="info">When targeting `bun`, identifiers are minified by default.</Callout>
