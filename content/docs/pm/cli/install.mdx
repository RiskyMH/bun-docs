...
For complete documentation on isolated installs, refer to [Package manager > Isolated installs](/docs/pm/isolated-installs).
...
<include>../../../_snippets/cli/install.mdx</include>