...
<Frame>![Running 266 React SSR tests faster than Jest can print its version number.](https://bun.com/docs/images/buntest.jpeg)</Frame>
...
<include>../../_snippets/cli/test.mdx</include>
