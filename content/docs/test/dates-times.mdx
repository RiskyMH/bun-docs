...
<Callout type="info">Timers are not impacted yet, but may be in a future release of Bun.</Callout>
...
<Callout type="warning">**Timers** — Built-in timer mocking is not implemented yet, but it is on the roadmap.</Callout>
...
<Callout type="info">Unlike in Jest, you can change the time zone multiple times at runtime.</Callout>
