...
export function getMDXComponents(components?: MDXComponents): MDXComponents {
  ...
  return {
    ...
    ReactTweet: Tweet,
    Frame: (props) => <div {...props} className={cn("p-2 border bg-fd-card shadow-md rounded-2xl *:my-0! [&_p_>_*]:my-0! [&_p_>_.rounded-lg]:rounded-xl [&_>_img]:rounded-xl my-[2em]", props.className)}>{props.children}</div>,
